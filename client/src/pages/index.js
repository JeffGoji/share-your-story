    ...
    return (
        ...
        <div className='d-flex justify-content-center'>
            ...
            <div className="col-sm-12 col-md-12 col-lg-8 col-xl-8 rounded-3 card-shadow box-bg">
                ...
                <blockquote className="text-black p-3">Hi and welcome to Share Your Story! We are a Texas based orginization and uour mission is to educate and help victims of medical malpractice find the resources and information that they deserve need after suffering an injury at the hands of the medical industry and for those afflicted to have a space onine where they can share their stories in a supportive environment.
                    <br />
